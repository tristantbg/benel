module.exports = function(grunt) {
    grunt.initConfig({
        concat: {
            plugins: {
                src: ['site/plugins/oembed/assets/js/oembed.js', 'node_modules/flickity/dist/flickity.pkgd.min.js', 'lib/history.js/scripts/bundled/html4+html5/jquery.history.js'],
